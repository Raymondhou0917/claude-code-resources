...
這份 Starter Kit 採用 **MIT License**——程式碼可以自由使用、修改、分享，甚至用在商業專案裡。**但請保留腳本 header 的原作者資訊**，這是 MIT 的基本要求，也是對創作者的尊重。

**商標聲明**：「雷蒙三十」「Raymond Hou」「雷蒙 Starter Kit」為雷蒙三十品牌所有。你可以 fork 這份程式碼、改成自己的版本、甚至拿去賣，但**不能冠上這些品牌名稱販售**（例如不能叫「Raymond Claude Code Starter Kit Pro」）。fork 版請用你自己的名字，這是對原品牌的基本界線。

真正的付費內容是 **[Claude Code 迷你課 / 訓練營](https://cc.lifehacker.tw)**——教學脈絡、社群問答、持續 curation 的新設定包。Starter Kit 只是暖身。
